<template>
  <v-container class="py-10 px-8">
    <!-- Cabeçalho -->
    <p class="text-caption text-grey-darken-1 mb-1" style="color: #344054">Meu Painel > #Notificações</p>
    <v-row class="mb-6">
      <v-col cols="12" class="d-flex align-center">
        ...
        <div>
          <p class="text-h6 font-weight-black mb-0" style="color: #2F3367">Notificações</p>
          <p class="text-body-3 text-grey-darken-1 mt-2 ">
...
export default defineComponent({
  ...
  methods: {
    goBack() {
      this.$router.push('/gestor/gestorMain');
    },
  },
});
</script>
